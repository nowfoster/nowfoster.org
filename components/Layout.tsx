...
import { blogUrl, linkedInUrl, facebookUrl, instaUrl, twitterUrl } from "../config"
        ...
        <div className={s.footerInner}>
          ...
          <div className={s.connect}>
            <div className={s.mailingList}>
              <Link href="https://tinyletter.com/amdamdamd56"> {/*CHANGE THIS LINK*/}
